...
struct
  ...
  fun check_bounds(arr_beg, ind_reg, (line,c), arr_szeCB, arr_label1, arr_label2) =[
	Mips.BGEZ(ind_reg,arr_label2), Mips.LABEL(arr_label1), 
	Mips.LI("5",makeConst line), Mips.J "_IndexOutOfBoundsError_", 
	Mips.LABEL(arr_label2), Mips.LW(arr_szeCB, arr_beg , "0"), 
	Mips.SUB(arr_szeCB,ind_reg,arr_szeCB), 
